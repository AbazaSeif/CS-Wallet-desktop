...
public class PoolListGetResult implements org.apache.thrift.TBase<PoolListGetResult, PoolListGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<PoolListGetResult> {
  ...
  private static final org.apache.thrift.protocol.TField POOLS_FIELD_DESC = new org.apache.thrift.protocol.TField("pools", org.apache.thrift.protocol.TType.LIST, (short)3);
  ...
  public PoolListGetResult setStatus(APIResponse status) {
    this.status = status;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<Pool>(_list26.size);
                Pool _elem27;
                for (int _i28 = 0; _i28 < _list26.size; ++_i28)
                {
                  _elem27 = new Pool();
                  _elem27.read(iprot);
                  struct.pools.add(_elem27);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.pools = new java.util.ArrayList<Pool>(_list31.size);
          Pool _elem32;
          for (int _i33 = 0; _i33 < _list31.size; ++_i33)
          {
            _elem32 = new Pool();
            _elem32.read(iprot);
            struct.pools.add(_elem32);
          }
        }
        struct.setPoolsIsSet(true);
      }
